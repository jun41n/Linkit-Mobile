...
const styles = StyleSheet.create({
  ...
  label: { fontFamily: "Gaegu_700Bold", fontSize: 16, marginTop: 6 },
  inputBox: {
    borderRadius: 14,
    borderWidth: 1,
  ...
  input: { fontFamily: "Gaegu_700Bold", fontSize: 18 },
  ...
  kindLabel: { fontFamily: "Gaegu_700Bold", fontSize: 16 },
  kindDesc: { fontFamily: "Gaegu_400Regular", fontSize: 13, marginTop: 2 },
  ...
  createBtnText: { fontFamily: "Gaegu_700Bold", fontSize: 17 },
});
