...
const styles = StyleSheet.create({
  ...
  title: { flex: 1, textAlign: "center", fontFamily: "Gaegu_700Bold", fontSize: 18 },
  ...
  message: { fontFamily: "Gaegu_400Regular", fontSize: 15, lineHeight: 22 },
  bold: { fontFamily: "Gaegu_700Bold" },
  when: { fontFamily: "Gaegu_400Regular", fontSize: 12, marginTop: 2 },
});
